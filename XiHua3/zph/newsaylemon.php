...
session_start(); 
 include_once '../Tools/mysql_base.php';//连接到mysql_base.php
 	$pageNo=$_GET['pageNo'];
	$sql=$mysql_DB->selectAll("newsaylemon", array("*"));//调用$mysql_DB->selectAll()语句，查询全部。
...
/*	if(empty($_SESSION['like'])){
	...
	if(!empty($_POST['sb'])){
		 $like=$_POST['like'];
		$_SESSION['like']=$like;
		  $sql=$mysql_DB->likeSelect("newsaylemon", array("*"), array("title"=>$like,"author"=>$like),"or");
		 $query=$mysql_DB->query($sql);
	}
  ...
  <div class="middle">
    <div class="middle-top">
      <ul>
        <li><b>你的位置：</b></li>
        <li style="width:60px;"><a href="Index.php">首页</a>&nbsp;&gt;&gt;</li>
        <li style="width:78px;"><a href="aylemon.php">安岳柠檬</a>&nbsp;&gt;&gt;</li>
         <li style="width:62px;"><a href="newsaylemon.php">新闻咨讯</a></li>
      </ul>
    </div>
    ...
    <div class="middle-right">
      <div class="middle-right1">
        <div class="mr1">新闻咨讯</div>
        
        <div style="float:right">
        <form action="newsaylemon.php?fn=like" method="post">
      ...
      <div id="middle-right2">
        <ul>
           <?php 
              ...
              ?>
          <li><img src="images/6.png" />&nbsp;<a href="news-content-newsay.php?id=<?php echo $rs['id']?>"><?php echo $rs['title']?></a>
      ...
      <div id="middle-right3">
        <ul>
         <li style="width:45px;">共<?php echo $pageNum;?>页</li>
          <li style="width:40px;"><a href="newsaylemon.php?pageNo=1">首页</a></li>
          <li style="width:50px;"><a href="newsaylemon.php?pageNo=<?php echo $pageNo-1;?>">上一页</a></li>
          <li><a href="newsaylemon.php?pageNo=1">1</a></li>
          <li><a href="newsaylemon.php?pageNo=2">2</a></li>
          <li><a href="newsaylemon.php?pageNo=3">3</a></li>
         
          
		  <li style="width:50px;"><a href="newsaylemon.php?pageNo=<?php echo $pageNo+1;?>">下一页</a></li>
          <li style="width:40px;"><a href="newsaylemon.php?pageNo=<?php echo $pageNum;?>">尾页</a></li>
