...
session_start(); 
 include_once '../Tools/mysql_base.php';//连接到mysql_base.php
 	$pageNo=$_GET['pageNo'];
	$sql4=$mysql_DB->selectAll("cpfreshlemon", array("*"));//调用$mysql_DB->selectAll()语句，查询全部。
    ...
    <div class="middle-top">
      <ul>
        ...
        <li style="width:78px;"><a href="cplemon.php">柠檬产品</a>&nbsp;&gt;&gt;</li>
         <li style="width:62px;"><a href="cpfreshlemon.php">新鲜柠檬</a></li>
      </ul>
    </div>
    ...
    <div class="middle-right">
        ...
        <ul>
          <?php 
              $pageNum=$mysql_DB->pageNum(9, $sql4);//获取最大页码数
               ...
               ?>
          <li><a href="cpfreshlemon2.php?id=<?php echo $rs4['id']?>""><?php echo "<img src='../".$rs4['text']."'/>".$rs4['title']?></a>
      ...
      <div id="middle-righ3">
        <ul>
          ...
          <li style="width:40px;"><a href="cpfreshlemon.php?pageNo=1">首页</a></li>
          <li style="width:50px;"><a href="cpfreshlemon.php?pageNo=<?php echo $pageNo-1;?>">上一页</a></li>
          <li><a href="cpfreshlemon.php?pageNo=1">1</a></li>
          <li><a href="cpfreshlemon.php?pageNo=2">2</a></li>
          <li><a href="cpfreshlemon.php?pageNo=3">3</a></li>
         
          
		  <li style="width:50px;"><a href="cpfreshlemon.php?pageNo=<?php echo $pageNo+1;?>">下一页</a></li>
          <li style="width:40px;"><a href="cpfreshlemon.php?pageNo=<?php echo $pageNum;?>">尾页</a></li>
