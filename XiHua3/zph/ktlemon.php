...
/*	if(empty($_SESSION['like'])){
	...
	if(!empty($_POST['sb'])){
		 $like=$_POST['like'];
		$_SESSION['like']=$like;
		  $sql3=$mysql_DB->likeSelect("ktlemon", array("*"), array("title"=>$like,"author"=>$like),"or");
		 $query3=$mysql_DB->query($sql3);
	}
  ...
  <div class="middle">
    <div class="middle-top">
      <ul>
        <li><b>你的位置：</b></li>
        <li style="width:60px;"><a href="Index.php">首页</a>&nbsp;&gt;&gt;</li>
        <li style="width:62px;"><a href="ktlemon.php">柠檬课堂</a></li>
      </ul>
    </div>
    <div class="middle-left">
      <div class="middle-left1">
        <ul>
          <li style="font-size:22px; text-align:center; background-image:url(images/318.png); background-repeat:repeat-y; color:#FFFFFF;"><a href="ktlemon.php">柠檬课堂</a></li>
          <li style="background:url(images/4314.png) no-repeat 0 15px; margin-top:10px"><a href="rdlemon.php">柠檬热点</a></li>
    ...
    <div class="middle-right">
      <div class="middle-right1">
        <div class="mr1">柠檬课堂</div>
        
         <div style="float:right">
        <form action="ktlemon.php?fn=like" method="post">
      ...
      <div id="middle-right2">
        <ul>
         <?php 
              $pageNum=$mysql_DB->pageNum(12, $sql3);//获取最大页码数
              	//当前页码数
              	if(empty($pageNo)){
              		$pageNo=1;
              	}
              	//分页显示
              	$pageNo=$mysql_DB->pageNo(12, $sql3, $pageNo);
              		$sql3=$mysql_DB->page(12, $sql3, $pageNo);
              	$query3=$mysql_DB->query($sql3);
              	while ($rs3=mysql_fetch_array($query3)){
             	
              ?>
          <li><img src="images/6.png" />&nbsp;<a href="news-content-kt.php?id=<?php echo $rs3['id']?>"><?php echo $rs3['title']?></a>
            <div id="middle-right2-li-right">作者：<?php echo $rs3['author']?>  <?php echo $rs3['date']?></div>
          </li>
          <?php }?>
      ...
      <div id="middle-right3">
        <ul>
          ...
          <li style="width:40px;"><a href="ktlemon.php?pageNo=1">首页</a></li>
          <li style="width:50px;"><a href="ktlemon.php?pageNo=<?php echo $pageNo-1;?>">上一页</a></li>
          <li><a href="ktlemon.php?pageNo=1">1</a></li>
          <li><a href="ktlemon.php?pageNo=2">2</a></li>
          <li><a href="ktlemon.php?pageNo=3">3</a></li>
         
          
		  <li style="width:50px;"><a href="ktlemon.php?pageNo=<?php echo $pageNo+1;?>">下一页</a></li>
          <li style="width:40px;"><a href="ktlemon.php?pageNo=<?php echo $pageNum;?>">尾页</a></li>
