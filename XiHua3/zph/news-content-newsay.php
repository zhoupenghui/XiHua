...
session_start();
    include_once '../Tools/mysql_base.php';
    	...
    	//查询新闻
	$sql=$mysql_DB->selectWhere("newsaylemon", array("*"), array("id"=>"$id"));
  ...
  <div class="middle">
    ...
    <div class="middle-right">
      ...
      <div id="middle-right3">
        <ul>
       <li  style="width:60px;"><a href="news-content-newsay.php?id=<?php echo $id-1;?>" >上一篇	</a></li>
	 <li  style="width:60px;"><a href="news-content-newsay.php?id=<?php echo $id+1;?>" >下一篇</a></li>
        </ul>
      </div>
    </div>
  </div>
